// -----------------------------------------------------------------------
//  <copyright file="CommunicationCryptor.cs" company="SF开源团队">
...
namespace SF.Utility.Secutiry
{
    ...
    public class CommunicationCryptor
    {
        ...
        private static readonly string Separator = Convert.ToBase64String(Encoding.UTF8.GetBytes("#@|SF|@#"));
